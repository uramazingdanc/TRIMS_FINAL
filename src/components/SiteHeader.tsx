      ...
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-2">
          <Link to="/" className="flex items-center gap-2">
            <span className="text-xl font-bold text-tmis-primary">TMIS</span>
          </Link>
        </div>
        ...
        {user && (
          <nav className="hidden md:flex items-center gap-6">
            {user.role === 'admin' ? (
              ...
              <>
                <Link to="/tenant/dashboard" className="text-sm font-medium hover:text-tmis-primary">
                  Dashboard
                </Link>
                <Link to="/tenant/payments" className="text-sm font-medium hover:text-tmis-primary">
                  Payments
                </Link>
                <Link to="/tenant/maintenance" className="text-sm font-medium hover:text-tmis-primary">
                  Maintenance
                </Link>
                <Link to="/tenant/profile" className="text-sm font-medium hover:text-tmis-primary">
                  Profile
                </Link>
              </>
            )}
